...
% 
% G = grad_f_C14(BETA) renvoie en G le vecteur colonne representant le gradient 
% de la fonctionnelle des moindres carres calculee en le vecteur BETA. Elle 
