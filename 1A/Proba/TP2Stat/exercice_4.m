...
[min,k] = min([val_propre(1,1), val_propre(2,2)]);

cos_theta_estime = vect_propre(1,k);
sin_theta_estime = vect_propre(2,k);
rho_estime =  G(1) * cos_theta_estime + G(2) * sin_theta_estime;
