...
for i = 1:taille_alphabet-1
	bornes(2,i) = frequences(i) + bornes(1,i)
...
% L'algorithme de Huffman est vraiment inadapté dans le cas où le texte
% comporte un grand nombre de caractères différents
