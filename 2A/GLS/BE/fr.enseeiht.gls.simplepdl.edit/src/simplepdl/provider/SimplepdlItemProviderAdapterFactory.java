...
public class SimplepdlItemProviderAdapterFactory extends SimplepdlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link simplepdl.UseResources} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected UseResourcesItemProvider useResourcesItemProvider;

	/**
	 * This creates an adapter for a {@link simplepdl.UseResources}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createUseResourcesAdapter() {
		if (useResourcesItemProvider == null) {
			useResourcesItemProvider = new UseResourcesItemProvider(this);
		}

		return useResourcesItemProvider;
	}
	...
	public void dispose() {
		...
		if (useResourcesItemProvider != null) useResourcesItemProvider.dispose();
	}
