...
public class SimplepdlAdapterFactory extends AdapterFactoryImpl {
	...
	protected SimplepdlSwitch<Adapter> modelSwitch =
		new SimplepdlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseUseResources(UseResources object) {
				return createUseResourcesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link simplepdl.UseResources <em>Use Resources</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see simplepdl.UseResources
	 * @generated
	 */
	public Adapter createUseResourcesAdapter() {
		return null;
	}
