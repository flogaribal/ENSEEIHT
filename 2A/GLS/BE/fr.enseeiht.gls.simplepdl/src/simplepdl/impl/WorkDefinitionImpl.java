...
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	 ...
	 * @ordered
	 */
	protected EList<UseResources> uses;
	 ...
	 * @generated
	 */
	public EList<UseResources> getUses() {
		if (uses == null) {
			uses = new EObjectContainmentEList<UseResources>(UseResources.class, this, SimplepdlPackage.WORK_DEFINITION__USES);
		}
		return uses;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__USES:
				getUses().clear();
				getUses().addAll((Collection<? extends UseResources>)newValue);
				return;
		}
