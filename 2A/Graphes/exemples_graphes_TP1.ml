...
add_vertex g_semi_euler v1;;
add_vertex g_semi_euler v2;;
add_vertex g_semi_euler v3;;
add_vertex g_semi_euler v4;;
add_vertex g_semi_euler v5;;
add_vertex g_semi_euler v6;;
add_vertex g_semi_euler v7;;
add_vertex g_semi_euler v8;;

add_edge g_semi_euler v1 v2;;
add_edge g_semi_euler v2 v3;;
add_edge g_semi_euler v3 v4;;

add_edge g_semi_euler v2 v5;;
add_edge g_semi_euler v5 v6;;
add_edge g_semi_euler v6 v2;;

add_edge g_semi_euler v3 v7;;
add_edge g_semi_euler v7 v8;; 
add_edge g_semi_euler v8 v3;;
