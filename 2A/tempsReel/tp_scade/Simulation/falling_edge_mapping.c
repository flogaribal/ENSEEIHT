...
void _SCSIM_Mapping_falling_edge() {
	...
	pSimulator->m_pfnAddLocal(pSimulator, "_L6", &_SCSIM_kcg_bool_Utils, 1, valid, 0, 0);
	...
	pSimulator->m_pfnAddLocal(pSimulator, "_L7", &_SCSIM_kcg_bool_Utils, 5, valid, 0, 0);
	pSimulator->m_pfnAddOutput(pSimulator, "y", &_SCSIM_kcg_bool_Utils, 6, valid, 0, 0);
	pSimulator->m_pfnAddInput(pSimulator, "x", &_SCSIM_kcg_bool_Utils, 7, valid, 0, 0);
}
