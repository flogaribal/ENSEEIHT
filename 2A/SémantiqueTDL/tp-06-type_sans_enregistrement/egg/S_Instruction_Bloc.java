...
if  (att_eval)	  action_inst_9(x_4, x_6, x_7);
  ...
  private void regle30() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_30(x_3, x_4, x_6);
...
if  (att_eval)	  action_inst_30(x_3, x_4, x_6);
  }
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#auto_inh","Instruction -> identificateur affectation Expression point_virgule #inst ;", e });
}
  }
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#auto_inh","Instruction -> Type identificateur affectation Expression point_virgule #inst ;", e });
}
  }
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#inst","Instruction -> Type identificateur affectation Expression point_virgule #inst ;", e });
}
  }
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#inst","Instruction -> identificateur affectation Expression point_virgule #inst ;", e });
}
  }
...
private void action_ast_47(S_Type_Bloc x_3, T_Bloc x_4) throws Exception {
try {
// locales
...
private void action_auto_inh_30(S_Type_Bloc x_3, T_Bloc x_4, S_Valeur_Bloc x_6) throws Exception {
try {
// instructions
...
private void action_auto_inh_47(S_Type_Bloc x_3, T_Bloc x_4) throws Exception {
try {
// instructions
x_3.att_factory=this.att_factory;
x_3.att_tds=this.att_tds;
...
private void action_inst_30(S_Type_Bloc x_3, T_Bloc x_4, S_Valeur_Bloc x_6) throws Exception {
try {
// locales
