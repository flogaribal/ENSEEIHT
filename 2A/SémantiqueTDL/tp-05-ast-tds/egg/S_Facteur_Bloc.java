...
if  (att_eval)	  action_ast_28(x_3, x_5);
  }
...
this.att_ast=this.att_factory.createVariableUse(((VariableDeclaration)loc_tmp));
}
else if (loc_tmp instanceof ConstantDeclaration ){
this.att_ast=((ConstantDeclaration)loc_tmp).getValue();
}
else {
...
private void action_ast_28(S_Expression_Bloc x_3, S_Expression_Bloc x_5) throws Exception {
try {
// instructions
...
private void action_auto_inh_28(S_Expression_Bloc x_3, S_Expression_Bloc x_5) throws Exception {
try {
// instructions
x_3.att_factory=this.att_factory;
