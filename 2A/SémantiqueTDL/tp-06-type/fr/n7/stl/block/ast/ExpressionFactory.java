...
public interface ExpressionFactory {
	...
	/**
	* Create a node for an address access in the Abstract Syntax Tree.
	* @param _expr expression of address access
	* @return Abstract Syntax Tree node for the creation of a collection of values.
	**/
	public Expression createAddressAccess(Expression _expr);

	/**
	* Create a node for an array allocation in the Abstract Syntax Tree.
	* @param _type array type
	* @param _expr expression of array allocation
	* @return Abstract Syntax Tree node for the creation of a collection of values.
	**/
	public Expression createArrayAllocation(Type _type, Expression _expr);

	/**
	* Create a node for a pointer allocation in the Abstract Syntax Tree.
	* @param _type pointer's type
	* @return Abstract Syntax Tree node for the creation of a collection of values.
	**/
