...
int [] sync= new int[0];
  ...
  private void regle9() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_9(x_3);
	x_2.analyser(LEX_Bloc.token_sinon);
	x_3.analyser() ;
if  (att_eval)	  action_ast_9(x_3);
  }
  private void regle8() throws Exception {

	//declaration
	//appel
if  (att_eval)	  action_ast_8();
  }
private void action_ast_9(S_Bloc_Bloc x_3) throws Exception {
try {
// instructions
...
private void action_auto_inh_9(S_Bloc_Bloc x_3) throws Exception {
try {
// instructions
...
private void action_ast_8() throws Exception {
try {
// instructions
this.att_ast=null;
