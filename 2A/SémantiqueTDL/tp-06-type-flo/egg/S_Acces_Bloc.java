...
int [] sync= new int[0];
  ...
  private void regle56() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_56(x_3, x_5);
	x_2.analyser(LEX_Bloc.token_point);
	x_3.analyser(LEX_Bloc.token_identificateur);
if  (att_eval)	  action_inh_56(x_3, x_5);
	x_5.analyser() ;
if  (att_eval)	  action_ast_56(x_3, x_5);
  }
...
private void action_auto_inh_56(T_Bloc x_3, S_Acces_Bloc x_5) throws Exception {
try {
// instructions
...
private void action_inh_56(T_Bloc x_3, S_Acces_Bloc x_5) throws Exception {
try {
// instructions
...
private void action_ast_56(T_Bloc x_3, S_Acces_Bloc x_5) throws Exception {
try {
// instructions
