...
if  (att_eval)	  action_inh_51(x_2, x_4);
	x_4.analyser() ;
if  (att_eval)	  action_ast_51(x_2, x_4);
  }
private void action_auto_inh_51(T_Bloc x_2, S_SuiteAffectable_Bloc x_4) throws Exception {
try {
// instructions
...
private void action_inh_51(T_Bloc x_2, S_SuiteAffectable_Bloc x_4) throws Exception {
try {
// locales
...
att_scanner._interrompre(IProblem.Semantic, att_scanner.getBeginLine(), IBlocMessages.id_B_02, BlocMessages.B_02,new Object[]{""+x_2.att_txt});
...
private void action_ast_51(T_Bloc x_2, S_SuiteAffectable_Bloc x_4) throws Exception {
try {
// instructions
