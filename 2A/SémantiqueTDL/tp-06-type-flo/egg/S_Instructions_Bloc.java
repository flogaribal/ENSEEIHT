...
int [] sync= new int[0];
  ...
  SymbolTable att_tds;
  boolean att_eval;
  LinkedList<Instruction> att_listInst;
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#auto_inh","Instructions -> Instruction Instructions1 #listInst ;", e });
}
  }
private void action_listInst_6(S_Instruction_Bloc x_2, S_Instructions_Bloc x_3) throws Exception {
try {
// instructions
this.att_listInst= new LinkedList<Instruction>(x_3.att_listInst);
this.att_listInst.addFirst(x_2.att_inst);
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#listInst","Instructions -> Instruction Instructions1 #listInst ;", e });
}
  }
private void action_listInst_5() throws Exception {
try {
// instructions
this.att_listInst= new LinkedList<Instruction>();
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#listInst","Instructions -> #listInst ;", e });
}
  }
