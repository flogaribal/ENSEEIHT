...
public class RecordTypeImpl implements RecordType, Scope<FieldDeclaration> {
	...
	public boolean equalsTo(Type _other) {
		if (_other instanceof RecordType){
			return ((RecordType)_other).getName().equals(this.getName());			
		}
		return false;
	...
	public boolean compatibleWith(Type _other) {
		if (_other instanceof RecordType){
			if (((RecordType)_other).getName().equals(this.getName())) {
				return true;
			}
		}
		return false;
	...
	/* Pour tous les champs rajouter leur offset */
	@Override
	...
	/* (non-Javadoc)
	 * @see java.lang.RecordType#getFields()
	 */
	@Override
