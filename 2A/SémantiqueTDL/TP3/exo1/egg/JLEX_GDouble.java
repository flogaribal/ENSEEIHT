...
public class JLEX_GDouble implements  LEX_ANALYZER  {
	...
	public JLEX_GDouble (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	public JLEX_GDouble (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
...
"4:9,3:2,4:2,3,4:18,3,4:13,1,4,2:10,4:198,0:2")[0];
...
"1,2,3,4,5,-1:8,4,-1");
	...
	return new Yytoken(LEX_GDouble.EOF , "EOF" , yyline , yychar , yychar+1 ) ;
			}
...
case 2:
	...
	{return new Yytoken(LEX_GDouble.token_point, yytext(), yyline, yychar, yychar+1);}
...
case 3:
	...
	{return new Yytoken(LEX_GDouble.token_chiffre, yytext(), yyline, yychar, yychar+1);}
...
case 4:
	...
	{return new Yytoken(LEX_GDouble.token_separateur, yytext(), yyline, yychar, yychar+1);}
...
case 5:
	...
	{return new Yytoken(LEX_GDouble.token_autre, yytext(), yyline, yychar, yychar+1);}
