...
pense(i) == /\ etat[i] = Eating
            /\ fourchettes' = [ fourchettes EXCEPT ![fourchDroite(i)] = Milieu ]
            /\ fourchettes' = [ fourchettes EXCEPT ![fourchGauche(i)] = Milieu ]
